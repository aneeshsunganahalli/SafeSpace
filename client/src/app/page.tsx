    ...
    <div className="min-h-screen bg-gradient-to-b from-white to-gray-50">
      ...
      <section className="pt-20 pb-12 px-6 max-w-6xl mx-auto">
        ...
        <div className="bg-white p-4 rounded-2xl shadow-lg max-w-4xl mx-auto">
          <div className="bg-gray-200 h-64 md:h-80 w-full rounded-xl flex items-center justify-center">
            <p className="text-gray-600 font-medium">Journal Dashboard Preview</p>
          </div>
        </div>
      </section>
